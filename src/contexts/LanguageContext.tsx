...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'templates.sports': 'Sports',
    'templates.architecture': 'Architecture',
    'templates.travel': 'Travel',
    'templates.medical': 'Medical',
    'templates.realestate': 'Real Estate',
  ...
  ar: {
    ...
    'templates.technology': 'التقنية',
    'templates.finance': 'المالية',
    'templates.sports': 'الرياضة',
    'templates.architecture': 'العمارة',
    'templates.travel': 'السفر',
    'templates.medical': 'الطبي',
    'templates.realestate': 'العقارات',
    'templates.restaurant': 'المطاعم',
    'templates.event': 'الفعاليات',
    'templates.ecommerce': 'التجارة الإلكترونية',
    'templates.corporate': 'الشركات',
    'templates.analytics': 'التحليلات',
